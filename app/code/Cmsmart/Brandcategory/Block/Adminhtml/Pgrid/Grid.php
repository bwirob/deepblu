<?php
namespace Cmsmart\Brandcategory\Block\Adminhtml\Pgrid;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
	...
	protected function _prepareColumns()
	{
	  $this->addColumn('choose_id', array(
			...
			'renderer'  => '\Cmsmart\Brandcategory\Block\Adminhtml\Renderer\Vercheckbox',
	...
	{
		return $this->getUrl('brandcategory/pgrid/grid', ['_current' => false]);
	}
