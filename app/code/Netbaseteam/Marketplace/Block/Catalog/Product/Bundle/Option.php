...
class Option extends \Netbaseteam\Marketplace\Block\Catalog\Product\Widget
{
    /**
     * Form element
     *
     ...
     * @var string
     */
    protected $_template = 'Netbaseteam_Marketplace::catalog/product/edit/bundle/option.phtml';
    ...
    public function getProduct()
    {
        if (!$this->getData('product')) {
            $this->setData('product', $this->_coreRegistry->registry('product_edit'));
        }
    ...
    protected function _prepareLayout()
    {
        $this->addChild(
            ...
            [
                ...
                'class' => 'add add-selection action-secondary'
            ]
        );
        ...
        $this->addChild(
            'selection_template',
            'Netbaseteam\Marketplace\Block\Catalog\Product\Bundle\Selection'
        );
    ...
    {
        if (!$this->_options && $this->getProduct()) {
