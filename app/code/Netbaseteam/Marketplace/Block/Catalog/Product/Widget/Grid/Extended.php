...
class Extended extends \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid 
{
    /**
     * Columns array
     * @var array
     ...
     * @var string
     */
    protected $_massactionBlockName = 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Massaction\Extended';
     ...
     * @var string
     */
    protected $_template = 'Netbaseteam_Marketplace::catalog/product/widget/grid/extended.phtml';
    ...
    protected function _prepareLayout()
    {
        $this->setChild(
            'export_button',
            $this->getLayout()->createBlock('Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Button')->setData(
                [
                    'label' => __('Export'),
    ...
    public function getColumnSet()
    {
        if (!$this->getChildBlock('grid.columnSet')) {
            $this->setChild(
                'grid.columnSet',
                $this->getLayout()->createBlock('Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\ColumnSet')
            );
        }
    ...
    public function addColumn($columnId, $column)
    {
        if (is_array($column)) {
            $this->getColumnSet()->setChild(
                $columnId,
                $this->getLayout()
                    ->createBlock('Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Column\Extended')
                    ->setData($column)
                    ->setId($columnId)
                    ->setGrid($this)
            );
    ...
    protected function _prepareMassactionColumn()
    {
        ...
        $massactionColumn = $this->getLayout()
            ->createBlock('Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Column')
            ->setData(
                [
     ...
     *
     * @param \Magento\Framework\DataObject $item
     * @param \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Column $column
     * @return boolean
     */
