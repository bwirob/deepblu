...
class Container extends \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Container
{
    /**#@+
     ...
     * @var string
     */
    protected $_blockGroup = 'Netbaseteam_Marketplace';

    /**
     * @var string
     */
    protected $_template = 'Netbaseteam_Marketplace::catalog/product/widget/grid/container.phtml';
