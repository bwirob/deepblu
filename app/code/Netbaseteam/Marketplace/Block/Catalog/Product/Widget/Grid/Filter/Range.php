...
class Range extends \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Filter\AbstractFilter
{
    /**
     * @return string
     */
    public function getHtml()
    {
        $html = '<div class="range"><div class="range-line">' .
            ...
            __(
                ...
                'from'
            ) . '" class="input-text netbaseteam__control-text no-changes" ' . $this->getUiId(
                'filter',
                $this->_getHtmlName(),
                'from'
            ) . '/></div>';
