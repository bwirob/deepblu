<?php
namespace Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid;

use Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Filter\AbstractFilter;

class Column extends \Netbaseteam\Marketplace\Block\Catalog\Product\Widget
{
    /**
     * Parent grid
     *
     * @var \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid
     */
    protected $_grid;
     ...
     * Column renderer
     *
     * @var \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\AbstractRenderer
     */
    protected $_renderer;
    ...
    protected $_rendererTypes = [
        'checkbox' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\Checkbox',
		'text' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\Longtext',
		'currency' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\Currency',
        'default' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\Text',
    ];
    ...
    protected $_filterTypes = [
        'range' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Filter\Range',
        'number' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Filter\Range',
        'currency' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Filter\Range',
        'skip-list' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Filter\SkipList',
        'default' => 'Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Filter\Text',
    ];
     ...
     *
     * @param \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid $grid
     * @return $this
     */
     ...
     * Get grid block
     *
     * @return \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid
     */
     ...
     * Set column renderer
     *
     * @param \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\AbstractRenderer $renderer
     * @return $this
     */
     ...
     *
     * @return \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\AbstractRenderer
     */
