...
class Container extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\ButtonList
     */
    protected $buttonList;

    /**
     * @var \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Toolbar
     */
    protected $toolbar;
    ...
    public function __construct(
		...
		\Netbaseteam\Marketplace\Block\Catalog\Product\Widget\ButtonList $buttonList,
		\Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Toolbar $toolbar,
		array $data = []
	)
    {
    ...
    public function getButtonsHtml($region = null)
    {
        ...
        foreach ($this->buttonList->getItems() as $buttons) {
            /** @var \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Item $item */
     ...
     *
     * @param \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Item $item
     * @return bool
     */
