...
class Checkbox extends \Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Renderer\AbstractRenderer
{
    /**
     * @var int
     */
    ...
    protected function _getCheckboxHtml($value, $checked)
    {
        ...
        $html .= 'class="' .
            ...
            ' netbaseteam__control-checkbox' . '"';
        $html .= $checked . $this->getDisabled() . '/>';
        $html .= '<label for="id_' . $this->escapeHtml($value) . '"></label>';
        $html .= '</label>';
        /* ToDo UI: add class="netbaseteam__field-label" after some refactoring _fields.less */
        return $html;
    }
    ...
    public function renderHeader()
    {
        ...
        $html .= 'class="netbaseteam__control-checkbox"' . $checked . $disabled . ' ';
