...
namespace Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Massaction;

class Extended extends \Netbaseteam\Marketplace\Block\Catalog\Product\Widget
{
    /**
     * Massaction items
     *
     ...
     * @var string
     */
    protected $_template = 'Netbaseteam_Marketplace::catalog/product/widget/grid/massaction_extended.phtml';
