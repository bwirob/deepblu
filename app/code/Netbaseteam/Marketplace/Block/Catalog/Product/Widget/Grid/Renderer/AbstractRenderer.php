...
use Netbaseteam\Marketplace\Block\Catalog\Product\Widget\Grid\Column;
use Magento\Framework\DataObject;


abstract class AbstractRenderer extends \Magento\Framework\View\Element\AbstractBlock
{
    /**
     * @var int
     */
    ...
    public function render(DataObject $row)
    {
        if ($this->getColumn()->getEditable()) {
            $result = '<div class="netbaseteam__grid-control">';
            $result .= $this->getColumn()->getEditOnly() ? ''
                : '<span class="netbaseteam__grid-control-value">' . $this->_getValue($row) . '</span>';
