 ...
 */
namespace Netbaseteam\Marketplace\Block\Cart\Item;
    ...
    \Magento\Framework\DataObject\IdentityInterface
{
     ...
     */
    protected $marketplace_helper;

    /**
     * @var \Netbaseteam\Marketplace\Model\SellerFactory
     */
    protected $_sellerDataFactory;
    ...
    public function getSellerProduct($product)
    {
        if($product) {
            $product_id = $product->getEntityId();
            $sellerId = $this->_productFactory->create()->getCollection()
                ->addFieldToFilter('product_id', $product_id)->addFieldToSelect('seller_id')->getData();
            if(count($sellerId)){
                $id = array();
                ...
                if (count($id)) {
                    $seller = $this->_sellerDataFactory->create()->getCollection()->addFieldToFilter('seller_id', array($id));
                    foreach($seller as $sellers) {
                        return  $sellers->getShopTitle();
                    }
                }
            }
        }
