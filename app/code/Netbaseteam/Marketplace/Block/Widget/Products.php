 ...
 */
class Products extends \Magento\Catalog\Block\Product\AbstractProduct implements BlockInterface, IdentityInterface
{
    /**
    ...
    public function __construct(
        ...
        \Netbaseteam\Marketplace\Model\ResourceModel\Product\CollectionFactory $mpProductCollectionFactory,
    ...
    {
        $mpCollection = $this->mpProductCollectionFactory->create()->addFieldToSelect('product_id')->getColumnValues('product_id');

        /** @var $collection \Magento\Catalog\Model\ResourceModel\Product\Collection */
        $collection = $this->productCollectionFactory->create();
        $collection->addAttributeToFilter('entity_id', array('in' => $mpCollection));
