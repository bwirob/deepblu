...
use Netbaseteam\Marketplace\Api\Data\MarketplaceSaveCartInterface;
use Netbaseteam\Marketplace\Api\MarketplaceSaveCartRepositoryInterface;

/**
 * MarketplaceSaveCart model
 *
 */
class MarketplaceSaveCart extends \Magento\Framework\Model\AbstractModel implements MarketplaceSaveCartInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'marketplace_savecart';
    ...
    {
        $this->_init('Netbaseteam\Marketplace\Model\ResourceModel\MarketplaceSaveCart');
    }
