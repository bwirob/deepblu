...
/**
 * MarketplaceSaveCart resource model
 */
class MarketplaceSaveCart extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    protected $_resource;
    /**
    ...
    {
        $this->_init('marketplace_savecart', 'entity_id');
    }
