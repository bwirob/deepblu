...
namespace Netbaseteam\Marketplace\Controller\Adminhtml\Transaction;
...
{
    const ADMIN_RESOURCE = 'Netbaseteam_Marketplace::marketplace_transaction';
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Netbaseteam_Marketplace::marketplace_transaction');
