define([
    ...
    'Netbaseteam_Marketplace/js/advanced-pricing-handler',
    'Netbaseteam_Marketplace/js/options/price-type-handler',
    'collapsible',
    ...
    return {
         ...
         */
        'Netbaseteam_Marketplace/js/configurable-type-handler': function (data) {
