...
define(
    [
        ...
        'Netbaseteam_Opc/js/action/set-coupon-code',
        'Netbaseteam_Opc/js/action/cancel-coupon',
        'Netbaseteam_Opc/js/cmsmart/components'
    ],
    function ($, ko, Component, quote, setCouponCodeAction, cancelCouponAction) {
        ...
        return Component.extend({
            defaults: {
                template: 'Netbaseteam_Opc/payment/discount'
            },
