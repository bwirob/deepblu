define(
    [
        ...
        'Netbaseteam_Opc/js/action/set-additional-information',
        'mage/calendar'
    ],
    function ($, ko, Component, quote, setAdditionalInformationAction, calendar) {
        ...
        var hsOscGiftwrap = ko.observable((quote.getTotals().cmsmart-opc_giftwrap_amount) ? true : false);
        var canShowSurveyOther = ko.observable(false);

        return Component.extend({
            defaults: {
                template: 'Netbaseteam_Opc/additional'
            },
            ...
            initialize: function () {
                ...
                if(this.canShowDeliveryDate) {
                    $("#cmsmart-opc-delivery-date").calendar({
                        showsTime: false,
                        dateFormat: "M/d/yy",
