(function (factory) {
    ...
    var _scrollTop = jQueryNetbaseteam.fn.scrollTop; // preserve original function

    jQueryNetbaseteam.cssHooks["pageYOffset"] = {
    ...
    jQueryNetbaseteam.fn.scrollTop = function (value) {
    ...
    var _scrollLeft = jQueryNetbaseteam.fn.scrollLeft; // preserve original function
    ...
    jQueryNetbaseteam.fn.scrollLeft = function (value) {
        if (typeof value == "undefined") {
            var nice = (this[0]) ? $.data(this[0], '__nicescroll') || false : false;
    ...
    jQueryNetbaseteam.fn.getNiceScroll = function (index) {
    ...
    jQueryNetbaseteam.extend(jQueryNetbaseteam.expr[':'], {
        nicescroll: function (a) {
            return ($.data(a, '__nicescroll')) ? true : false;
        }
    });

    jQueryNetbaseteam.fn.niceScroll = function (wrapper, opt) {
        ...
        opt = jQueryNetbaseteam.extend({}, opt); // cloning
