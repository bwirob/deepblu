<?php
namespace Netbaseteam\Faq\Block\Adminhtml\Faqcategory;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Netbaseteam_Faq::faq_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('faq_category')->getId()) {
            return __("Edit FAQ Category '%1'", $this->escapeHtml($this->_coreRegistry->registry('faq_category')->getName()));
        } else {
            return __('New FAQ Category');
        }
    }
    ...
    {
        return $this->getUrl('faq/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
