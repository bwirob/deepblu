...
use Netbaseteam\Blog\Model\ResourceModel\Category\CollectionFactory;
...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->_getSession()->addException($e, __('Something went wrong while updating the category(s) status.'));
        }
