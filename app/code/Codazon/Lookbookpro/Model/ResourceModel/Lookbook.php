...
class Lookbook extends \Magento\Eav\Model\Entity\AbstractEntity
{
    ...
    public function __construct(
		...
		\Codazon\Lookbookpro\Model\LookbookFactory $modelFactory,
        $data = []
    ) {
    ...
    {
        $this->_read = 'cdzlookbook_read';
        $this->_write = 'cdzlookbook_write';
    }
    
    public function getEntityType()
    {
        if(empty($this->_type)) {
            $this->setType(\Codazon\Lookbookpro\Model\Lookbook::ENTITY);
        }
    ...
    {
        return 'Codazon\Lookbookpro\Model\LookbookAttribute';
    }
     ...
     *
     * @param \Codazon\Lookbookpro\Model\Lookbook $lookbook
     * @return array
     */
    ...
    public function getLookbookItemGroupTable()
    {
        if (!$this->_lookbookItemGroupTable) {
            $this->_lookbookItemGroupTable = $this->getTable('cdzlookbook_item_group');
        }
