...
namespace Netbase\Sun\Model\Cssconfig;
...
class Generator
{
    ...
    public function __construct(
        \Netbase\Sun\Helper\Cssconfig $cssconfigData,
    ...
    protected function generateStoreCss($type, $storeId) {
        ...
        $str4 = 'sun/css/'.$type.'.phtml';
        $this->_coreRegistry->register('cssgen_store', $storeCode);

        try {
            $block = $this->_layoutManager->createBlock('Netbase\Sun\Block\Template')->setData('area','frontend')->setTemplate($str4)->toHtml();
